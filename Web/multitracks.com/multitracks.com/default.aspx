            ...
            <div class="header--holder">
               ...
               <div class="header--right">
                   <div style="margin-top:10px;margin-right:50px; font-size: 15px">
                       <a href="ArtistDetails?Id=">Artist Details</a>
                   </div>
               </div>
            </div>
         </header>
                           ...
                           <h2>Welcome!</h2>
                            ...
                            <script>
                                function GoToArtistDetails() {
                                    ...
                                    window.location.href = 'ArtistDetails?Id=' + Id;
                                }
                                function GoToSongs() {
                                    var Id = document.getElementById("Id").value;
                                    window.location.href = 'ArtistSongs?Id=' + Id;
                                }
                                function GoToAlbums() {
                                    var Id = document.getElementById("Id").value;
                                    window.location.href = 'ArtistAlbums?Id=' + Id;
                                }
